...
function (movie){
     ...
     document.title = `${title} - FlixFinder`;
     ...
     for(const { key, name } of filterVideos(videos)){
      ...
      videoCard.innerHTML = `
        ...
        frameboder="0" allowfullscreen="1" title="${name}" class="img-cover" loading="lazy" ></iframe>
      `;
...
const addSuggestedMovies = function({results: movieList}, title){
    ...
    movieListElem.ariaLabel = "Recommendation";

    movieListElem.innerHTML = `
        <div class="title-wrapper">
            <h3 class="title-large">Recommendation</h3>
        </div>
